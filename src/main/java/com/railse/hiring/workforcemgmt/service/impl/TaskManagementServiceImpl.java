...
public class TaskManagementServiceImpl implements TaskManagementService {
    ...
    private TaskManagementDto toDto(TaskManagement model) {
    ...
    private List<TaskManagementDto> toDtoList(List<TaskManagement> models) {
    ...
    public String assignByReference(AssignByReferenceRequest request) {
        ...
        for (Task taskType : applicableTasks) {
            ...
            // Current behaviour: reassign all tasks of this type
    ...
    public List<TaskManagementDto> fetchTasksByDate(TaskFetchByDateRequest request) {
        ...
        // BUG: no filtering logic for CANCELLED or date
